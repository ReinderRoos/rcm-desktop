...
def build_lcc_workspace_panel() -> LccWorkspacePanel:
    ...
    lcc_empty_state_label.setStyleSheet("color: #9E9E9E;")
    ...
    meekoppel_help_label.setStyleSheet("color: #616161; font-size: 11px;")
    ...
    meekoppel_whatif_hint_label.setStyleSheet("color: #757575;")
    meekoppel_content_layout.addWidget(meekoppel_whatif_hint_label)
    meekoppel_selection_summary_label = QLabel("")
    meekoppel_selection_summary_label.setWordWrap(True)
    meekoppel_selection_summary_label.setStyleSheet("color: #616161;")
    ...
    meekoppel_empty_label.setStyleSheet("color: #9E9E9E;")
